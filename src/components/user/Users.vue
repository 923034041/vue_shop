     ...
     <!-- 用户列表区域 -->
      ...
      <!-- 分页区域 -->
       <el-pagination  @size-change="handleSizeChange"  @current-change="handleCurrentChange"
        :page-sizes="[1, 2, 5, 10]"  :current-page="queryInfo.pagenum" :page-size="queryInfo.pagesize" :total="total" layout="total, sizes, prev, pager, next, jumper">
       </el-pagination>
       <!-- 添加用户对话框 -->
       <el-dialog title="提示" :visible.sync="addDialogVisible" ref="addFormRef" label-width="50%" @close="addDialogClosed">
         <!-- 内容主体区域 -->
